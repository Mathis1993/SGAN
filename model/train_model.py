...
def train(fold, res_dir, g_model, d_model, c_model, gan_model, b_model, train_dataset, train_targets, train_subject_idx, val_dataset, val_targets, latent_dim, n_epochs=20, n_batch=100):
    ...
    print("Supvervised Samples' Shape: {}, Supervised Targets' Shape: {}".format(dataset_sup.shape, dataset_sup.shape))
    print("Unupvervised Samples' Shape: {}, Supervised Targets' Shape: {}".format(dataset_real.shape, dataset_real.shape))
